...
async function main() {
    ...
    // 100 UST approve
    // await erc20.approve(process.env.ONE_ANCHOR_CONTRACT, "0x56BC75E2D63100000", {gasLimit: process.env.GAS_LIMIT});
    ...
    // await erc20.approve(process.env.ONE_ANCHOR_CONTRACT, "0x1043561A8829300000", {gasLimit: process.env.GAS_LIMIT});
